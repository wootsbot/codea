...
const questions = [
  ...
  },
  {
    id: '7',
    title: 'Resumen',
    content: 'Primero es necesario tener la idea de un artículo, después tienes que hacer un fork de codea, crear tu código en un archivo llamado index.md dentro de docs/markdown y agregar el autor y los tags correspondientes. Finalmente tienes que esperar a que tu PR (Pull Request) sea aceptado, es posible que te hagamos algunas sugerencias de estilo o cambios.'
  },
];
