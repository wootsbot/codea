...
Google Cloud Pub/Sub es un servicio de mensajería para intercambiar datos de eventos entre aplicaciones y servicios. :smile: Un productor de datos publica un mensaje en un tema de Cloud Pub/Sub. Un consumidor crea una suscripción a ese tema. Los suscriptores pueden extraer mensajes desde una suscripción o se configuran como webhooks :smile: para suscripciones push. Cada suscriptor debe confirmar cada mensaje dentro de un período configurable.
